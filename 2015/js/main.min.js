...
NC.Sequence = function (t) {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            .click(function () {
                window.open("./register", "_blank"), site.onExternal()
    ...
    load: function () {
        var t = this;
        /* this.data[this.currSeq].intro + */
        this.introVideo = H.createVideo(this.data[this.currSeq].intro + H.videoExt, {
                position: "absolute",
                opacity: "0",
                id: "_main_video"
...
NC.EndSequence = function (t, e) {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            overflow: "hidden",
            zIndex: "90"
        }, this.el), this.againVideo = H.createVideo(this.data.again + "" + H.videoExt + "" + Math.floor(1e3 * Math.random()), {
            position: "absolute"
...
NC.Cursor = function () {
    ...
    init: function () {
        ...
        this.respond = H.createImg("assets/img/cursor/respond.png", {
                ...
                width: "300px",
                letterSpacing: "1px"
            }, this.el), this.calcRoute.innerHTML = "LOADING AWESOMENESS...", this.search = H.createImg("assets/img/cursor/search.png", {
                position: "absolute",
                top: "-1px",
                left: "-1px",
                opacity: "0"
                ...
                fontFamily: "bebas-exp,sans-serif",
                fontWeight: "200"
            }, this.circle), this.nightcrawl.innerHTML = "ENGI<br/>FEST", this.captureFootage = H.createEl("div", {
                position: "absolute",
                top: "0px",
                paddingTop: "17px",
                left: "0px",
...
NC.WeatherWidget = function (t) {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            paddingLeft: "24px",
            marginTop: "17px"
        }, this.el), this.location.innerHTML = "<img src='./assets/img/logo.png' style='width: 125px;margin: -3px 17px'>", this.containerTemp = H.createEl("div", {
            position: "absolute",
            top: "35px",
            left: "0px",
            opacity: "0"
...
NC.TurnByTurn = function () {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            letterSpacing: "1px",
            opacity: "0.5"
        }, this.el), this.streets.innerHTML = "DELHI TECHNOLOGICAL UNIVERSITY", this.num = H.createEl("div", {
            position: "absolute",
            top: "32px",
            right: "30px",
            fontSize: "30px",
...
NC.VolumeUp = function () {
    ...
    animateOut: function () {
        var t = this;
        t.bottomline.innerHTML = "ALL SET! READY TO GO!", t.bottomline.style.color = "#ffff00", TweenMax.killTweensOf(this.numData), TweenMax.to(this.el, .5, {
            y: -50,
            opacity: 0,
            delay: 2,
            ease: Expo.easeOut,
...
NC.NavButton = function (t, e, i, n) {
    ...
    init: function () {
        ...
        }), this.character = H.createEl("div", null, this.el), this.character.style.height = "21px", this.main2 = H.createEl("div", null, this.character), this.hover2El = H.createEl("div", null, this.character), this.main2.innerHTML = this.hover2El.innerHTML = '<span class="castAs"></span> <span class="castCharBtn">' + site.data.pages[3].actors[this.ID].character + "</span>", TweenMax.set(this.main2, {
            position: "absolute",
            color: "#b2b2b2",
            rotationX: 0,
            transformOrigin: "left top"
        ...
        this.overlay = H.createEl("div", null, this.el), TweenMax.set(this.overlay, {
            ...
            .click(function () {
                (1 != t.pageID || site.data.pages[1].videos[t.ID].ytID) && (3 == t.pageID || (isMobile.any() || soundManager.play("transition"), "instagram" == t.pageID ? (window.open(site.data.pages[5].instagramLink, "_blank"), site.onExternal()) : 5 == t.pageID ? (window.open("./social", "_blank"), site.onExternal()) : (site.getPage(t.pageID, t.ID), $(".navItem")
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            .click(function () {
                ...
                padding: "10px 0"
            }, this.openRoad, site.loader), H.createLink(this.openRoad, "http://cistoner.org", "_blank"), isMobile.any() || $(this.openRoad)
            .hover(function () {
            ...
            .click(function () {
                ...
                marginTop: "8px",
                opacity: ".2"
            }, this.follow), this.follTitle.innerHTML = "FOLLOW US:", this.follFb = new NC.FollowButton("assets/img/footer/ico-fb.png", "https://www.facebook.com/engifest"), this.follow.appendChild(this.follFb.el), this.follTw = new NC.FollowButton("assets/img/footer/ico-tw.png", "https://twitter.com/engifest"), this.follow.appendChild(this.follTw.el), this.follTb = new NC.FollowButton("assets/img/footer/ico-tb.png", "http://engifest.tumblr.com/"), this.follow.appendChild(this.follTb.el), this.follIg = new NC.FollowButton("assets/img/footer/ico-ig.png", "http://instagram.com/engifest"), this.follow.appendChild(this.follIg.el), this.legalBtns = H.createEl("div", {
                position: "absolute",
                bottom: "0",
                right: "37px",
                height: "46px"
                ...
                cssFloat: "right",
                opacity: ".2"
            }, this.legalBtns), this.legalRat = new NC.LegalButton("Contact Us", "https://docs.google.com/forms/d/19zlKnSVrGwdm_r6UszjrXLKlzxnAi-xCjGgRM9jJ1rU"), this.legalBtns.appendChild(this.legalRat.el), this.legalMpaa = new NC.LegalButton("Engi Team", "./team/"), this.legalBtns.appendChild(this.legalMpaa.el), this.legalTerms = new NC.LegalButton("dce.edu", "http://dce.edu"), this.legalBtns.appendChild(this.legalTerms.el), this.legalPriv = new NC.LegalButton("", ""), this.legalBtns.appendChild(this.legalPriv.el)
    },
    animateIn: function () {
        TweenMax.to(this.el, 1, {
            bottom: 0,
...
NC.Share = function (t) {
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
                ...
                position: "absolute"
            }, this.bg, site.loader) : (this.bgVid = H.createVideo("assets/videos/Engi 8s" + H.videoExt, {
                position: "absolute"
...
NC.ShareButton = function (t, e) {
    ...
    init: function () {
        ...
        $(this.el)
            .click(function () {
                "tw" == t.type && window.open("https://twitter.com/intent/tweet?text=" + escape(site.data.share.twitter) + " http://www.engifest.dce.edu", "", "width=450, height=430, left=" + (site.screenWidth - 450) / 2 + ", top=" + (site.screenHeight - 430) / 2), "tb" == t.type && window.open("http://www.tumblr.com/share/photo?clickthru=" + escape(e) + "&source=" + escape(i) + "&caption=" + escape(site.data.share.tumblrFacebook), "", "width=450, height=430, left=" + (site.screenWidth - 450) / 2 + ", top=" + (site.screenHeight - 430) / 2), "pt" == t.type && window.open("http://www.pinterest.com/pin/create/button/?url=" + escape(e) + "&description=" + escape(site.data.share.pinterest) + "&media=" + escape(i), "", "width=765, height=430, left=" + (site.screenWidth - 765) / 2 + ", top=" + (site.screenHeight - 430) / 2), "fb" == t.type && FB.ui({
    ...
    init: function () {
        ...
        this.el = H.createEl("div", {
            ...
            .click(function () {
                ...
                console.info(e);
                "tw" == t.type && window.open("https://twitter.com/intent/tweet?text=" + escape(site.data.share.twitter) + " http://www.engifest.dce.edu/" + escape("#videos"), "", "width=450, height=430, left=" + (site.screenWidth - 450) / 2 + ", top=" + (site.screenHeight - 430) / 2), "tb" == t.type && window.open("http://www.tumblr.com/share/photo?clickthru=" + escape(i) + "&source=" + escape(e) + "&caption=" + escape(site.data.share.tumblrFacebook), "", "width=450, height=430, left=" + (site.screenWidth - 450) / 2 + ", top=" + (site.screenHeight - 430) / 2), "pt" == t.type && window.open("http://www.pinterest.com/pin/create/button/?url=" + escape(i) + "&description=" + escape(site.data.share.pinterest) + "&media=" + escape(e), "", "width=765, height=430, left=" + (site.screenWidth - 765) / 2 + ", top=" + (site.screenHeight - 430) / 2), "fb" == t.type && FB.ui({
                    method: "share_open_graph",
                    action_type: "og.likes",
                    action_properties: JSON.stringify({
                        object: site.baseURL,
...
NC.About = function (t) {
    ...
    init: function () {
        ...
        var n;
        n = '<span style="left: 49px; top: 0px; color: yellow">Engifest 2015</span>', n += '<span style="left: 147px; top: 0px; ">is the annual cultural festival </span>', n += '<span style="left: 340px; top: 0px; ">of Delhi Technological University, </span>', n += '<span style="left: 194px; top: 15px; ">Engifest is a four day cultural extravaganza </span>', n += "<span style=\"left: 119px; top: 37px; font-family: 'Verdana'; color: yellow; font-style: Italic\">held in the month of March!</span>", //       
            n += '<span style="left: 45px; top: 53px; color: #b6b2b2">Engifest comes</span>',
            n += "<span style=\"left: 152px; top: 53px; font-family: 'Verdana'; letter-spacing:2px\">as a breath</span>",
            n += "<span style=\"left: 252px; top: 53px; font-family: 'Verdana'; font-size: 11px\">of fresh air, bridging the gap between technical</span>",
            n += "<span style=\"left: 78px; top: 78px; font-family: 'Verdana'; font-size: 11px\">education and creativity. It is a much-needed.</span>",
            n += '<span style="left: 22px; top: 93px; ">wave, rich in cultural diversity, which rejuvenates, refreshes</span>',
            n += '<span style="left: 3px; top: 113px; ">and titillates the soul</span>',
            n += '<span style="left: 150px; top: 113px; ">and gives creativity a chance to flourish.</span>',
            n += '<span style="left: 19px; top: 141px; ">Engifest is a symbol</span>',
            n += '<span style="left: 162px; top: 141px; ">of</span>',
            n += '<span style="left: 180px; top: 141px; font-size: 11px ">achievement and pride. It is a product</span>',
            n += '<span style="left: 27px; top: 158px; font-size: 11px">of dreams, ambition and tireless hardwork, a true testimony</span>',
            n += '<span style="left: 125px; top:174px; font-style: italic">to the indomitable spirit, liveliness and sheer energy of youth.  </span>',this.synContent.innerHTML = n
    },
    animateIn: function (t) {
        var e = this;
...
NC.Gallery = function (t) {
    ...
    init: function () {
        console.info('gallery intialised!');
        var t = this;
        this.el = H.createEl("div", {
            position: "absolute",
            top: "0px",
...
NC.Site = function () {
    ...
    init: function () {
        ...
        this.baseURL = baseURL, this.loader = new PxLoader, this.wrapper = H.createEl("div", {
                ...
                position: "absolute"
            }, this.wrapper) : (this.bg = H.createVideo("assets/videos/loader/Engi 8s" + H.videoExt, {
                position: "absolute"
    ...
    parseData: function (t) {
        ...
        this.nav = new NC.Nav, this.epk.appendChild(this.nav.el), this.epkBtn = new NC.EPKButton, isMobile.any() || this.wrapper.appendChild(this.epkBtn.el), isMobile.any() && (this.navToggleBtn = new NC.NavToggleButton, this.epk.appendChild(this.navToggleBtn.el)), this.footer = new NC.Footer, this.epk.appendChild(this.footer.el), this.header = new NC.Header, this.epk.appendChild(this.header.el), this.share = new NC.Share, this.epk.appendChild(this.share.el), this.galleryShare = new NC.GalleryShare, this.epk.appendChild(this.galleryShare.el), this.videoShare = new NC.VideoShare, this.epk.appendChild(this.videoShare.el), isMobile.any() ? TweenMax.delayedCall(1, function () {
            ...
            if (t.completedCount == t.totalCount) {
...
$(document).ready(function () {
        site = new NC.Site;
        $("#navButtons").children("div").children(".navHeader").eq(0).children(".navWrapper").children("div").eq(2).on('click', function() {location.href = './events/';});
});

setTimeout(function() {
    console.info('finally events assigned!@');
    $("#navButtons").children("div").children(".navHeader").eq(0).children(".navWrapper").children("div").eq(2).on('click', function (e) {
        e.preventDefault();
        location.href = './events/';
    });
    $("#navBtn-0-2").on('click', function(e) {
        e.preventDefault();
        if (typeof e.offsetX != "undefined") {
            location.href = './events/';
        }
    });
    $("#navBtn-4-0").on('click', function(e) {
        e.preventDefault();
        console.info(e);
        if (typeof e.offsetX != "undefined")
