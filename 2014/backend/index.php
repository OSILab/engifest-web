			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> Events </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered" id="DataTables_Table_0">
						  ...
						  <tbody>
							<?php
								foreach($eventObj->event as $arr)
								{
									echo "<tr>";
										echo "<td>" .$arr['id'] ."</td>";
										echo "<td><a href='edit.php?content=".$arr['id'] ."' title='edit content of this event'>" .$arr['name'] ."</a></td>";
									echo "</tr>";
								}
							?>
